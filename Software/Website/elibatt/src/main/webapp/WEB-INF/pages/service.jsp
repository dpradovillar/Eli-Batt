...
<h2><a href="../..">ELIBATT</a> &raquo; <a href="index.html" class="active">Services</a></h2>
    ...
    <form action="" class="jNice">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class="action"><a href="#" class="view">View</a><a href="#" class="edit">Edit</a><a href="#"
        ...
        <fieldset>
            ...
            <p><label>Sample label:</label><input type="text" class="text-medium"/><input type="text"
