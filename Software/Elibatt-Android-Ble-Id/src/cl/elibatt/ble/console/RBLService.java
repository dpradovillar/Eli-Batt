...
public class RBLService extends Service {
    ...
    public final static UUID UUID_BLE_SHIELD_NAME = UUID.fromString(RBLGattAttributes.BLE_SHIELD_NAME);
    ...
    private void broadcastUpdate(final String action, final BluetoothGattCharacteristic characteristic) {
        ...
        // This is special handling for the Heart Rate Measurement profile. Data parsing is carried out as per profile
        // specifications:
    ...
    public boolean onUnbind(Intent intent) {
        // After using a given device, you should make sure that BluetoothGatt.close() is called such that resources are
        // cleaned up properly. In this particular example, close() is invoked when the UI is disconnected from the
        // Service.
        close();
